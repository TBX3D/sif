...
// TestExecuteHTTPChainPropagatesVariable is the flagship: step 1 extracts a
// token, step 2 injects it into a header and only then can match the protected
// body. it fails unless the value actually crossed between requests.
